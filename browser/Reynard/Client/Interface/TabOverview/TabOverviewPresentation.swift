...
private final class TabOverviewPageSnapshotView: UIView {
    ...
    init(image: UIImage) {
        ...
        shadowView.backgroundColor = .appSystemBackground
        shadowView.layer.applyContinuousCornerCurve()
        shadowView.layer.shadowColor = UIColor.black.cgColor
        shadowView.layer.shadowOpacity = 0
        shadowView.layer.shadowRadius = UX.shadowRadius
        shadowView.layer.shadowOffset = UX.shadowOffset
        clippingView.clipsToBounds = true
        clippingView.layer.borderColor = UIColor.appSeparator.withAlphaComponent(0.2).cgColor
