...
enum AddressBarMenu {
    ...
    private struct Identifier {
        static let addressBarMenu = UIMenu.Identifier("moe.bemly.reynard.AddressBarMenu")
        static let manageAddonsMenu = UIMenu.Identifier("moe.bemly.reynard.AddressBarMenu.ManageAddons")
    }
