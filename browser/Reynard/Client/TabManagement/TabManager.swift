...
protocol TabManagerDelegate: AnyObject {
    ...
    func tabManager(_ tabManager: TabManager, shouldStartExternalResponse response: ExternalResponseInfo, for session: GeckoSession, completion: @escaping (Bool) -> Void)
